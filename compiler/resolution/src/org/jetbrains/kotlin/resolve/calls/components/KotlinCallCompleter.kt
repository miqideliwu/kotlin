...
class KotlinCallCompleter(
    ...
    private  fun runCompletion(
        ...
        val unsubstitutedReturnType = resolvedCallAtom.candidateDescriptor.returnType?.unwrap()?.takeUnless { ErrorUtils.containsErrorType(it) }
                                      ?: constraintSystem.builtIns.unitType
        val returnType = resolvedCallAtom.substitutor.safeSubstitute(unsubstitutedReturnType)
